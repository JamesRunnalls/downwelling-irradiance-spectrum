...
def spectrum(f_dd=1, f_ds=1, theta_sun=30, beta=0.2606, alpha=1.317, H_oz=0.38, WV=2.5, AM=1, RH=60, P=1013.25, all_parameters=False):
    """Downwelling irradiance spectrum returns wavelength and E_d
    ...
    if all_parameters:
        return wavelength, E_d, E_dd, E_ds, E_dsr, E_dsa, T_r, T_aa, T_as, T_oz, T_o, T_wv, tau_a, M_dash
    else:
        return wavelength, E_d
